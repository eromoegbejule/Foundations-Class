{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "#API: 5d7edd43c49e039890125ce79182289d"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "url = \"http://ws.audioscrobbler.com/2.0/?method=artist.getsimilar&artist=lil&api_key=5d7edd43c49e039890125ce79182289d&format=json\""
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "response = requests.get(\"http://ws.audioscrobbler.com/2.0/?method=artist.getsimilar&artist=lil&api_key=5d7edd43c49e039890125ce79182289d&format=json\")\n",
    "data = response.json()"
   ]
  },
  {
   ...
   "outputs": [
    {
     ...
     "traceback": [
      ...
      "\u001b[0;32m<ipython-input-15-cc26b3364c6f>\u001b[0m in \u001b[0;36m<module>\u001b[0;34m\u001b[0m\n\u001b[0;32m----> 1\u001b[0;31m \u001b[0mresponse\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mkeys\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0m",
